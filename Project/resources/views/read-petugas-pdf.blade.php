...
<head>
	...
	<title>Surabaya Health Care  - Petugas</title>
...
<body>
	...
	<!--pasien-->
		<div class="container">
			<div class="row">
			<div class="col-md-12 col-sm-12">
					<h2 style="margin-top:15px;text-align:center"> Tabel Petugas Medis </h2>
					<br>
					<table class="table table-bordered table-hover" style="color:#17202A;table-layout: fixed;margin-top:5px">
				<thead>
