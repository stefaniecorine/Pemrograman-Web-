...
<head>
	<title>Login Petugas Medis</title>
		...
		<div class="container-login100" style="background-image: url('../img/bg-04.jpg');">
            ...
            @endif
				<span class="login100-form-title p-b-41">
					Medical Staff's Form
				</span>

				<form  action="/loginPostPetugas" method="post" class="login100-form validate-form p-b-33 p-t-5">
                {!! csrf_field() !!}
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						...
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
						<input type="checkbox" onclick="myFunction()"style="margin-left: 80px"><h2 style="font-size:15px;font-family: Ubuntu-Regular;
