...
<head>
	<title>Pemeriksaan Poliklinik - Tambah Data Petugas Medis</title>
...
<body>
	<section id="petugas" class="section-padding">
		<div class="container">
			<div class="row">
				<div class="col-sm-8">
				<a class="btn btn-info" role="button" href="/medis">Kembali</a>
					<form action="/medis/store" method="post" style="color:#282B2F">
						{{ csrf_field() }}
						...
						<div class="form-row">
							...
							<div class="form-group col-sm-4">
								...
								<input type="text" minlength="16" maxlength="16" class="form-control" name="no_ktp" id="no_ktp">
							</div>
						</div>
						...
						<div class="form-row">
							<div class="form-group col-sm-3">
								...
								<input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir" required="required" max="1997-12-31">
							</div>
							<div class="form-group col-sm-3">
							...
							<div class="form-group col-sm-4">
								...
								<input type="tel" maxlength="14" class="form-control" id="no_telp" name="no_telp" required="required">
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-sm-6">
						...
						<div class="form-row">
							<div class="form-group col-sm-6">
								...
								<input type="text" class="form-control" id="spesialisasi" name="spesialisasi" required="required">
							</div>
							<div class="form-group col-sm-4">
