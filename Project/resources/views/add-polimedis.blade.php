            ...
            <div class="col-md-12 col-sm-8">
                <div class="row">
                    <div class="col-md-4 col-sm-4">
                        <form action="/poli-medis/store" method="post" style="color:#282B2F">
                            {{ csrf_field() }}
                            <h3>Tambah Data Poli</h3> <br>

                            <div class="form-group">
                                <input type="text" class="form-control" id="nama" name="nama" required="required" placeholder="Nama Poli">
