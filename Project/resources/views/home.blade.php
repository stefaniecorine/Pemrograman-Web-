              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="/login-pasien">Pasien</a></li>
                    <li><a href="/login-petugas">Petugas Medis</a></li>
                    <li><a href="/login-pegawai">Pegawai</a></li>
                  </ul>
                </li>
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
            <h3 class="cnt-ttl">Having Any Query? Or Give us Any Suggestion</h3>
            <div class="space"></div>
            
            <div id="errormessage"></div>
            
            <form action="/store-saran" method="post" role="form">
            {{ csrf_field() }}
              ...
              <div class="form-group">
								<input type="email" class="form-control" data-rule="email" id="email" name="email" required aria-describedby="emailHelp" placeholder="Your Email" />
								<div class="validation"></div>
							</div>
              <div class="form-group">
								<input type="text" placeholder="Subject" type="text" class="form-control" id="subject" name="subject" required>
								<div class="validation"></div>
							</div>
              <div class="form-group">
							<textarea minlength="15" maxlength="100" class="form-control" id="message" name="message" required >
              </textarea>
              </div>
              ...
              <br>
              <p id="print" style="color:black"></p>
            </form>
          </div>
        </div>
      </div>
